...
void main() {
  ...
  // !(느낌표) : nullable type으로 선언을 했을 때 변수 뒤에 !를 붙여 null인 경우 오류가 발생하도록 만듦
  //           변수명에 !를 붙이면, Non-nullable의 타입
  String? name4 = 'FUCKKKKK';
  print(name4!);
  name4 = null;
  print(name4);
